...
sha256sum build/libs/Alter.jar
...
cp native/build-aarch64/src/Release/Alter.exe build/win-aarch64/
cp build/libs/Alter.jar build/win-aarch64/
...
echo Alter.exe aarch64 sha256sum
sha256sum build/win-aarch64/Alter.exe

dumpbin //HEADERS build/win-aarch64/Alter.exe
