...
cp native/build-x86/src/Release/Alter.exe build/win-x86/
cp build/libs/Alter.jar build/win-x86/
...
echo Alter.exe 32bit sha256sum
sha256sum build/win-x86/Alter.exe

dumpbin //HEADERS build/win-x86/Alter.exe
