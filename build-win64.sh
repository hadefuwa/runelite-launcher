...
cp native/build-x64/src/Release/Alter.exe build/win-x64/
cp build/libs/Alter.jar build/win-x64/
...
echo Alter.exe 64bit sha256sum
sha256sum build/win-x64/Alter.exe

dumpbin //HEADERS build/win-x64/Alter.exe
