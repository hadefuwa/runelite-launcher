...
chmod 644 build/libs/Alter.jar

cp native/build-aarch64/src/Alter build/linux-aarch64/
cp build/libs/Alter.jar build/linux-aarch64/
...
# Symlink AppRun -> Alter
ln -s Alter AppRun

# Ensure Alter is executable to all users
chmod 755 Alter
popd
